...
config_cl = {
    ...
    joinDuration = 15000,               -- Duration in ms to allow players to join the race
    ...
    uniqueBlipNames = true,            -- True = blip's name will be the name of the race, False = every blip will be called Custom Race and will be grouped together
